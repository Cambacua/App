import type { DestinationDto, IDestinationAppService } from './models';
...
export class DestinationService {
  ...
  create = (input: IDestinationAppService, config?: Partial<Rest.Config>) =>
  ...
  update = (id: string, input: IDestinationAppService, config?: Partial<Rest.Config>) =>
    this.restService.request<any, DestinationDto>({
      method: 'PUT',
      url: `/api/app/destination/${id}`,
      body: input,
